...
experiments=(
# "--lr 1e-5 --weight-decay 1e-4 --embedding-k 64 --batch-size 64"
...
# "--lr 1e-5 --embedding-k 64 --batch-size 256 --pos-topk 3"
# "--lr 1e-4 --embedding-k 64 --batch-size 256"
# "--lr 1e-4 --embedding-k 64 --batch-size 256 --pos-topk 3"
# "--lr 1e-5 --embedding-k 32 --batch-size 128"
# "--lr 1e-5 --embedding-k 32 --batch-size 128 --pos-topk 3"
"--lr 1e-5 --embedding-k 64 --batch-size 128"
"--lr 1e-5 --embedding-k 64 --batch-size 128 --pos-topk 3"
"--lr 1e-4 --embedding-k 64 --batch-size 128"
"--lr 1e-4 --embedding-k 64 --batch-size 128 --pos-topk 3"
"--lr 1e-5 --embedding-k 32 --batch-size 64"
"--lr 1e-5 --embedding-k 32 --batch-size 64 --pos-topk 3"
"--lr 1e-5 --embedding-k 64 --batch-size 64"
"--lr 1e-5 --embedding-k 64 --batch-size 64 --pos-topk 3"
"--lr 1e-4 --embedding-k 64 --batch-size 64"
"--lr 1e-4 --embedding-k 64 --batch-size 64 --pos-topk 3"
