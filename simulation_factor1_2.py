    ...
    for n_items in n_items_list:
        for n_factors in n_factors_list:
            ...
            for random_seed in range(1, repeat_num+1):
                ...
                prob_y1 = sigmoid(Lambda_y @ Z.T + epsilon_y)  # Treatment group
                controlled_logit = NonLinearity(n_factors)(torch.Tensor(Lambda_y), torch.Tensor(Z)).detach().numpy()
                prob_y0 = sigmoid(controlled_logit + epsilon_y)  # Control group
