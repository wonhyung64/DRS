...
total_interactions = torch.tensor(total_feedback)
total_interactions = total_interactions.to("mps")


pref_user_sim_ = torch.matmul(total_interactions, total_interactions.T).cpu().numpy()
...
pref_item_sim_ = torch.matmul(total_interactions.T, total_interactions).cpu().numpy()
